...
class Assignment(db.Model):
    ...
    @classmethod
    def graded(cls, assignment_new: 'Assignment'):
        if assignment_new.id is not None:
            assignment = Assignment.get_by_id(assignment_new.id)
            assertions.assert_found(assignment, 'No assignment with this id was found')
            assertions.assert_valid(assignment.state == AssignmentStateEnum.DRAFT,
    ...
    def submit(cls, _id, teacher_id, principal: Principal):
        ...
        assertions.assert_valid(assignment.state == AssignmentStateEnum.SUBMITTED, 'Assignment already submitted')
        print(assignment.state == AssignmentStateEnum.SUBMITTED )   
